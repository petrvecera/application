...
$(document).ready(function(){
  ...
  // The date picker form for exporting the data
  $('input.export-from-input').on('change', function(e){
    e.stopPropagation();

    var from_date = $('input.export-from-input').datepicker('getDate');
    ...
    var to_date = $('input.export-to-input').datepicker('getDate');

    if ( ! to_date || ( to_date && to_date.getTime() < from_date.getTime() )) {
      $('input.export-to-input').datepicker('setDate', $('input.export-from-input').datepicker('getFormattedDate'));
    }
  });
